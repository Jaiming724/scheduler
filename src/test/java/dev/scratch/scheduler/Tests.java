...
public class Tests {
    public static void main(String[] args) {
        ...
        TimeFrame timeFrame4 = new TimeFrame(LocalTime.of(15, 0, 0), LocalTime.of(23, 59, 59));
        ...
        scheduleService.addAction(new SoftAction(Duration.ofMinutes(45), "Task 2", new DayOfWeek[]{DayOfWeek.MONDAY}, 0, 30));
        scheduleService.addAction(new SoftAction(Duration.ofMinutes(45), "Task 3", new DayOfWeek[]{DayOfWeek.MONDAY}, 15, 30));
