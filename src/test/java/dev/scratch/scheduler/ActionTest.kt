...
object ActionTest{
    ...
    fun main(args: Array<String>) {
        ...
        val hardAction1 = HardAction("Lunch", timeFrame2, arrayOf(DayOfWeek.MONDAY), 0, 0)
        ...
        scheduleService.addAction(SoftAction(Duration.ofMinutes(30), "Task 1", arrayOf(DayOfWeek.MONDAY), 0, 0))
        ...
        scheduleService.schedule()[DayOfWeek.MONDAY]?.printSchedule()
    }
}